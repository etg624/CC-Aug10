...
    var env = process.env.NODE_ENV;
    ...
    var emergencyMessage = process.env.EMERGENCY_MESSAGE;
     ...
     var serverAddress = process.env.SERVER_ADDRESS;
      ...
      //###### Wed Aug 1 10:03:30 PDT 2018 Microsoft graph variables
      var msGraphClientID = process.env.MICROSOFT_GRAPH_CLIENTID
      var msGraphClientSecret = process.env.MICROSOFT_GRAPH_SECRET
      var msGraphEndpoint = process.env.MICROSOFT_GRAPH_ENDPOINT 
      var msGraphContactsEndpoint = process.env.MICROSOFT_GRAPH_CONTACTS_ENDPOINT
      var msGraphGroupsEndpoint = process.env.MICROSOFT_GRAPH_GROUPS_ENDPOINT
...
console.log('sess.userType = '+sess.userType);
 ...
 if (sess.userType == '2'){
    res.render('settings', { title: 'Command Center' + name, username: sess.username, version, env, dbHost, dbName, dbUser, dbPass, ccSSL, port, infileDis, infileLocal, exportSource, pacsHost, pacsUser, pacsPassword, certName, certPass, sweep, sweepDir, sweepScope, pictureDir, sweepTime, muster, eventTypeEnabled, scanLimit, relayHost, latitude, longitude, emailHost, emailPort, emailSecure, emailUser, emailPass, emailFrom, emergencyTitle, emergencyMessage, twilioSID, twilioToken, serverAddress, eventAdminEmail, eventEndProcessing, eventEndFreq, msGraphClientID, msGraphClientSecret, msGraphContactsEndpoint, msGraphEndpoint, msGraphGroupsEndpoint });
    } else {
...
exports.settingsUpdate = function(req, res) {
    ...
    //###### Wed Aug 1 10:43:14 PDT 2018 Microsoft Graph variables
...
        {
        ...
        {
        value: 'EVENTEND_MONITOR='+req.body.eventEndRadios
        },
        {
        ...
        {
        value: 'MICROSOFT_GRAPH_CLIENTID='+req.body.msGraphClientID
        },
        {
        value: 'MICROSOFT_GRAPH_SECRET='+req.body.msGraphClientSecret
        },
        {
        value: 'MICROSOFT_GRAPH_ENDPOINT='+req.body.msGraphEndpoint
        },
        {
        value: 'MICROSOFT_GRAPH_CONTACTS_ENDPOINT='+req.body.msGraphContactsEndpoint
        },
        {
        value: 'MICROSOFT_GRAPH_GROUPS_ENDPOINT='+req.body.msGraphGroupsEndpoint
        }];
