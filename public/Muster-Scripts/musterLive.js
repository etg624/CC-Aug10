...
function initMap() {
    ...
    function getTotalAttendance() {
        ...
        xhr.open("GET", serverAddress + "/musterAttendance/" + musterID, true);
        xhr.send(null);
    ...
    function getUnknowns() {
        ...
        xhr.open("GET", serverAddress + "/musterUnknowns/" + musterID, true);
        xhr.send(null);
    }
    ...
    function getInvalids() {
        ...
        xhr.open("GET", serverAddress + "/musterInvalids/" + musterID, true);
        xhr.send(null);
    }
    ...
    function getUnaccounted() {
        ...
        xhr.open("GET", serverAddress + "/musterEvacuation/", true);
        xhr.send(null);
    }
    ...
    function updateMarkers() {
        ...
        xhr.open("GET", serverAddress + "/musterGetPoints/" + musterID, true);
        xhr.send(null);
    ...
    function textUnaccounted() {
        ...
        xhr.open("POST", serverAddress + "/sendsmsalert", true);
